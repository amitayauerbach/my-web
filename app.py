...
app.config['MAIL_USERNAME'] = 'amitayay1@gmail.com'  # Replace with your email
app.config['MAIL_PASSWORD'] = 'brbv hbya dtzs xvdn'  # Replace with your app password
app.config['MAIL_DEFAULT_SENDER'] = 'amitayay1@gmail.com'
